            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8 mt-3">
                    <div class="sign-up-from">
                        <h1 class="mb-0">Register Member</h1>
                        @if (session('status'))
                        ...
                        @endif
                        <form class="mt-3" action="/register-process" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail2">Email<span class="text-danger">*</span></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">No Handphone<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control mb-0" id="exampleInputPassword1"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tanggal Lahir<span
                                                class="text-danger">*</span></label>
                                        <input type="date" class="form-control mb-0" id="exampleInputPassword1"
                                            placeholder="Nomor Handphone" name="tanggal_lahir">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control mb-0" id="exampleInputPassword1"
                                            placeholder="Nomor KTP / NIK" name="no_ktp">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
